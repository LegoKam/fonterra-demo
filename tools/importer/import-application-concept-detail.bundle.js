...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-application-concept-detail.js
  var import_application_concept_detail_exports = {};
  __export(import_application_concept_detail_exports, {
    default: () => import_application_concept_detail_default
  });
  ...
  var TILE_ITEM_SELECTOR = ".tileCarousel__slick--tile, .pageteaser-tile__slick-tile, .tileListing__card";
  function parseTileCarousel(element, document) {
    const seen = /* @__PURE__ */ new Set();
    let tiles = Array.from(element.querySelectorAll(TILE_ITEM_SELECTOR)).filter((tile) => !tile.classList.contains("slick-cloned"));
  ...
  var import_application_concept_detail_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_application_concept_detail_exports);
})();
